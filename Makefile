...
#FFLAGS	= -pc 64 -Kieee -O0 -Ktrap=fp -Minform=inform -Mbounds -Mlre=noassoc # without OpenMP
#FFLAGS	= -pc 64 -Kieee -O0 -mp -Minfo -Ktrap=fp -Minform=inform -Mbounds -Mlre=noassoc # with OpenMP
# -- nimbus
